...
public:
  ...
  */
  ...
  /*!
    ...
    TEMPORARY_ONLY
  */
  virtual PlusStatus AddItem(vtkPolyData* polyDataPtr, long frameNumber, double unfilteredTimestamp = UNDEFINED_TIMESTAMP, double filteredTimestamp = UNDEFINED_TIMESTAMP);
